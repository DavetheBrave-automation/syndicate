...
def mock_markets() -> list:
    ...
    samples = [
        ("KXWTI-26APR15-T95.00", "oil",     22, 24, 18, 800),
        ("KXWTI-26APR15-T100.00", "oil",    14, 16, 12, 1200),
        ("KXGOLD-26APR-T2400", "gold",      55, 58, 50, 600),
        ("KXNG-26MAY-T3.50", "natgas",      35, 38, 30, 400),
        ("KXBTC-26APR15-T70K", "btc",       42, 45, 38, 1500),
        ("KXETH-26APR15-T3500", "eth",      28, 31, 25, 700),
        ("KXMLB-26-NYY", "sports",          12, 14, 11, 5000),
        ("KXNHL-26-VGK", "sports",           7,  9,  6, 2200),
        ("KXNBA-26-LAL", "sports",           4,  6,  3, 3100),
        ("KXFFR-26MAY-CUT25", "rates",      18, 21, 16, 900),
        ("KXSPX-26APR-T5500", "stocks",     65, 68, 62, 1100),
        ("KXUSDJPY-26APR-T160", "forex",    48, 51, 45, 850),
        ("KXMVESPORTS-S2026XYZ", "sports",  15, 18, 13, 50),  # blocked prefix
    ]
    out = []
    for ticker, _, yb, ya, last, vol in samples:
        out.append({
            "ticker": ticker,
            "yes_bid": yb,
            "yes_ask": ya,
            ...
            "last_price": last,
            "volume_24h": vol,
            "hours_to_expiry": random.choice([4, 18, 36, 60, 96, 168, 400]),
            "close_time": base_t + 3600 * random.choice([4, 18, 36, 60, 96]),
        })
    return out
